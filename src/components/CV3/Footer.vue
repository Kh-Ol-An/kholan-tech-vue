    ...
    <footer class='footer section'>
        <div class='container'>
            ...
            <div class='footer__content section__content'>
                <div class='footer__content-contacts'>
                    <ul class='footer__content-contacts-list'>
                        <li class='footer__content-contacts-list-item'>
                            <h4 class='footer__content-contacts-list-item-title'>{{ getContentLang.phone }}</h4>
                            <a href='tel:+380508899268'
                               class='footer__content-contacts-list-item-link'>+38 050 88 99 268</a>
                        </li>
                        <li class='footer__content-contacts-list-item'>
                            <h4 class='footer__content-contacts-list-item-title'>Email</h4>
                            <a href='mailto:olegkhristenko@gmail.com'
                               class='footer__content-contacts-list-item-link'>olegkhristenko@gmail.com</a>
                        </li>
                        <li class='footer__content-contacts-list-item'>
                            <h4 class='footer__content-contacts-list-item-title'>Skype</h4>
                            <a href='skype:hristenkoleg?chat'
                               class='footer__content-contacts-list-item-link'>hristenkoleg</a>
                        </li>
                        <li class='footer__content-contacts-list-item'>
                ...
                <div class='footer__content-presentation-bottom'>
                    <h2 class='footer__content-presentation-bottom-title'>
                        <span class='footer__content-presentation-bottom-title-name'>{{ getContentLang.name }}</span>
                        <span class='footer__content-presentation-bottom-title-surname'>{{
                                getContentLang.surname
                            }}</span>
                    </h2>
                    <ul class='footer__content-presentation-bottom-list'>
                        <li class='footer__content-presentation-bottom-list-item'>
